...
def update_appcast(version, desc):
    ...
    version_info = {
        ...
        'desc': desc,
        'sha256': file_hash,
        'url': f'https://github.com/Brain777777/bob-plugin-gemini/releases/download/v{version}/{release_file.name}',
        'minBobVersion': '0.5.0'
    }
    ...
    if appcast_file.is_file():
        ...
        appcast = dict(identifier='gle.gemini.translator', versions=[])
